...
<h2 class="mini-title">그래픽용/노트북</h2>
        <!-- //고정 header-->
        <div id="content">
            <!-- -------------햄버거 메뉴 시작------------ -->
       ...
       /* -----상품 더보기----  */
		...
		$(function(){
			$(".select").click(function(){
				...
				location.href = "${pageContext.request.contextPath}/item/hPrdList/hPrdGraphic.do?item_brand="+select;
			})
		})
			...
			$(".select1").click(function(){
				...
				location.href = "${pageContext.request.contextPath}/item/hPrdList/hPrdGraphic.do?&item_cpu="+select;
			})
		})
			...
			$(".select2").click(function(){
				...
				location.href = "${pageContext.request.contextPath}/item/hPrdList/hPrdGraphic.do?&item_inch="+select;
			})
		})
			...
			$(".select3").click(function(){
				...
				location.href = "${pageContext.request.contextPath}/item/hPrdList/hPrdGraphic.do?&item_ram="+select;
			})
		})
			...
			$(".select4").click(function(){
				...
				location.href = "${pageContext.request.contextPath}/item/hPrdList/hPrdGraphic.do?&item_os="+select;
			})
		})
		...
		$(function(){
			$(".select5").click(function(){
				...
				location.href = "${pageContext.request.contextPath}/item/hPrdList/hPrdGraphic.do?&item_weight="+select;
			});
		});
		$(function(){
	           $("#keyword").click(function(){
