...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/css/resetPw.css">
    <!--Sweetalert CSS-->
        ...
        <div id="content">
           ...
           <%@ include file="../inc/fixed.jsp" %>
            ...
            <div class="tab-content">
                <h4><br>새로운 비밀번호를 입력하세요.</h4>
                <div class="form-group">
                    <form id="confirm_pw" method="post" action="${pageContext.request.contextPath}/login/resetPw_ok.do">
                        <input type="password" name="user_pw" id="user_pw" class="form-control" placeholder="새 비밀번호 입력" />
                        <input type="password" name="mem_pw" id="user_pw_re" class="form-control" placeholder="새 비밀번호 확인" />
                        <div id="reset_pw">
            ...
            $('.form-control').focusout(function() {
                ...
                if (pwd1 == pwd2 && pwd1 != '') {
                    ...
                    swal({
                        ...
                        if (result.value) {
                        	form.action = "${pageContext.request.contextPath}/login/resetPw_ok.do";
                        	form.submit();
                        }
                    });
                }
