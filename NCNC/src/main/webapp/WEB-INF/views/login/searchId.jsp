...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/css/searchId.css">
    <!--Sweetalert CSS-->
    ...
    <div id="container">
        ...
        <div id="content">
            ...
            <div class="tab-content">
                <div class="tab-pane fade  in active" id="searchId">
                    <h4 class="header-tab"><br>본인명의 이메일주소로 인증</h4>
                    <p class="lead-tab">
                        회원님의 명의로 등록된 이메일로<br>
                        가입여부 및 본인여부를 확인합니다.
                    </p>
                    <form name="log_form" id="log_form" method="post" action="${pageContext.request.contextPath}/login/searchId_ok.do">
                        <div class="form-group">
                            <input type="text" id="user_name" name="mem_name" class="form-control" placeholder="이름" />
                            <input type="email" id="email" name="mem_email" class="form-control" placeholder="이메일주소" />
                            <div id="search_id">
            ...
            $("#log_form").submit(function(e) {
                ...
                if (!name) { // 입력값이 없다면?
                    ...
                    swal({
                        ...
                        if (result.value) {
                        	form.action = "${pageContext.request.contextPath}/login/searchId_ok.do";
                        	form.submit();
                        }
                    });
                }
