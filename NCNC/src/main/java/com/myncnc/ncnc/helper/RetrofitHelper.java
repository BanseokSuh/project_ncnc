...
public class RetrofitHelper {
	 ...
	 * 
	 * @param baseUrl - 접근하고자 하는 API의 기본주소 ( ex: http://도메인 )
	 * @return Retrofit 객체
	 */
	 ...
	 * Retrofit이 이 클래스의 객체를 통해 통신 과정을 의마하는 문자열을
	 * log() 메서드로 전달한다.
	 */
	 ...
	 * 이 클래스가 통신정보에 HTTP 헤더를 강제로 추가하는 기능을 수행한다
	...
	public class MyInterceptor implements Interceptor{
		...
		public Response intercept(Chain chain) throws IOException {
			...
			builder.header("User-Agent", "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/80.0.3987.149 Safari/537.36");
